                ...
                <div className="mb-5">
                  ...
                  <div className="border border-2 border-dashed rounded-3 p-3">
                    ...
                    <div className="btn-group w-100">
                      ...
                      { tempProduct.imagesUrl.length > 1 && tempProduct.imagesUrl[tempProduct.imagesUrl.length-1] !== '' && (<button onClick={handleRemoveImage} className="btn btn-outline-danger btn-sm w-100">取消圖片</button>)}
